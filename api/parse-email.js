// /api/parse-email  – Vercel Serverless Function
...
/** Convierte textos tipo “nombre arroba gmail punto com” → email válido */
function formatEmailText(input) {
  ...
  const IGNORE = new Set([
    "espacio","espacios","todo","junto","todojunto","sin","y","con",
    "la","el","los","las","por","favor","porfavor","porfa"
  ]);
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (!text) {
      res.status(400).json({ error: 'Falta el parámetro "text" (string).' }); return;
    }
